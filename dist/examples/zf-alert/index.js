...
__vue_options__.__file = "/Users/linzaifei/Desktop/linzaifei/Weex/project/zf_components/src/examples/zf-alert/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-1d6d8aa6"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("点击弹出样式二")])]), _c('zf-alert', {
    attrs: {
      "content": "这是样式二这是样式二这是样式二这是样式二这是样式二",
      "okTitle": "确定",
      "cancelTitle": "取消",
      "show": _vm.show1
    },
