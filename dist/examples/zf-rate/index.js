...
__vue_options__.__file = "/Users/linzaifei/Desktop/linzaifei/Weex/project/zf_components/src/examples/zf-rate/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-9facc628"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("样式1(iconWidth=80、bgColor=red,rate=4)")]), _c('zf-rate', {
    attrs: {
      "rate": "4",
      "iconWidth": "40",
      "bgColor": "red"
    ...
    staticClass: ["title"]
  }, [_vm._v("样式2(iconWidth=80、rate=3.5)")]), _c('zf-rate', {
    attrs: {
      "rate": "3.5",
      "iconWidth": "80"
    }
