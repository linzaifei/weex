...
__vue_options__.__file = "/Users/linzaifei/Desktop/linzaifei/Weex/project/zf_components/src/examples/zf-selectItem/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-52ad728a"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    data: function data() {
        return {
            list: ["https://gw.alicdn.com/tps/TB1JyaCPFXXXXc9XXXXXXXXXXXX-140-140.jpg", 'https://gw.alicdn.com/tps/TB1cTmLPFXXXXXRXXXXXXXXXXXX-140-140.jpg', 'https://gw.alicdn.com/tps/TB1U8avPFXXXXaDXpXXXXXXXXXX-140-140.jpg', 'https://gw.alicdn.com/tps/TB17Xh8PFXXXXbkaXXXXXXXXXXX-140-140.jpg', 'https://gw.alicdn.com/tps/TB1cTmLPFXXXXXRXXXXXXXXXXXX-140-140.jpg', 'https://gw.alicdn.com/tps/TB1oCefPFXXXXbVXVXXXXXXXXXX-140-140.jpg'],
            list1: ["https://gw.alicdn.com/tps/TB1JyaCPFXXXXc9XXXXXXXXXXXX-140-140.jpg", 'https://gw.alicdn.com/tps/TB1cTmLPFXXXXXRXXXXXXXXXXXX-140-140.jpg'],
            list2: ["https://gw.alicdn.com/tps/TB1JyaCPFXXXXc9XXXXXXXXXXXX-140-140.jpg", 'https://gw.alicdn.com/tps/TB1cTmLPFXXXXXRXXXXXXXXXXXX-140-140.jpg'],
            list3: ["https://gw.alicdn.com/tps/TB1JyaCPFXXXXc9XXXXXXXXXXXX-140-140.jpg", 'https://gw.alicdn.com/tps/TB1cTmLPFXXXXXRXXXXXXXXXXXX-140-140.jpg'],
            list4: ["https://gw.alicdn.com/tps/TB1JyaCPFXXXXc9XXXXXXXXXXXX-140-140.jpg", 'https://gw.alicdn.com/tps/TB1cTmLPFXXXXXRXXXXXXXXXXXX-140-140.jpg']
        };
    },
    created: function created() {},

    components: {
        ZfSelectItem: _index.ZfSelectItem
    },
    methods: {
        addPhoto: function addPhoto() {
            this.list.push("https://gw.alicdn.com/tps/TB1cTmLPFXXXXXRXXXXXXXXXXXX-140-140.jpg");
        },
        addPhoto1: function addPhoto1() {
            this.list1.push("https://gw.alicdn.com/tps/TB1oCefPFXXXXbVXVXXXXXXXXXX-140-140.jpg");
        },
        addPhoto2: function addPhoto2() {
            this.list2.push("https://gw.alicdn.com/tps/TB1oCefPFXXXXbVXVXXXXXXXXXX-140-140.jpg");
        },
        addPhoto3: function addPhoto3() {
            this.list3.push("https://gw.alicdn.com/tps/TB1oCefPFXXXXbVXVXXXXXXXXXX-140-140.jpg");
        },
        addPhoto4: function addPhoto4() {
            this.list4.push("https://gw.alicdn.com/tps/TB1oCefPFXXXXbVXVXXXXXXXXXX-140-140.jpg");
        }
    }
}; //
//
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("样式一(默认样式)")]), _c('zf-select-item', {
    attrs: {
      "list": _vm.list
    },
    on: {
    ...
    staticClass: ["title"]
  }, [_vm._v("样式二(count=3、max=12、space=5、margin=5)")]), _c('zf-select-item', {
    attrs: {
      "count": "3",
      "list": _vm.list1,
      "max": "12"
    ...
    on: {
      "addPhoto": _vm.addPhoto1
    }
  })], 1), _c('div', {
    staticClass: ["item1"]
  }, [_c('text', {
    staticClass: ["title"]
  }, [_vm._v("样式三(count=3、max=5、space=12、margin=5)")]), _c('zf-select-item', {
    attrs: {
      "count": "3",
      "space": "20",
      "list": _vm.list2,
    ...
    on: {
      "addPhoto": _vm.addPhoto2
    }
  })], 1), _c('div', {
    staticClass: ["item1"]
  }, [_c('text', {
    staticClass: ["title"]
  }, [_vm._v("样式四(count=4、max=10、space=5、margin=20)")]), _c('zf-select-item', {
    attrs: {
      "count": "4",
      "margin": "20",
      "list": _vm.list3,
    ...
    on: {
      "addPhoto": _vm.addPhoto3
    }
  })], 1), _c('div', {
    staticClass: ["item1"]
  }, [_c('text', {
    staticClass: ["title"]
  }, [_vm._v("样式五(count=2、max=10、space=5、margin=5)")]), _c('zf-select-item', {
    attrs: {
      "count": "2",
      "list": _vm.list4,
      "max": "10"
