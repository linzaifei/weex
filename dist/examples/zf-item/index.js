...
__vue_options__.__file = "/Users/linzaifei/Desktop/linzaifei/Weex/project/zf_components/src/examples/zf-item/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-b2583142"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    components: {
        ZfItem: _index.ZfItem
    },
    methods: {
        clickItem: function clickItem(e) {
            modal.toast({
                message: '点击cell' + e.data.key
            });
        },
        onchange: function onchange(e) {
            modal.toast({
                message: '点击开关' + e.data.key + '  ' + e.data.index
            });
        }
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("样式一")]), _vm._l((_vm.list), function(item, index) {
    return _c('div', [_c('zf-item', {
      attrs: {
        "leftTitle": item.title,
        "leftFont": _vm.leftFont,
        "leftColor": item.leftColor,
        "leftImg": item.img,
        "rightTitle": item.rightTitle,
        "rightImg": item.rightImg,
        "rightFont": item.rightFont,
    ...
    staticClass: ["title"]
  }, [_vm._v("自定义样式")]), _c('zf-item', [_c('div', {
    attrs: {
      "slot": "left"
    },
    slot: "left"
  }, [_c('text', [_vm._v("这是自定义样式")])]), _c('div', {
    attrs: {
      "slot": "right"
    },
    slot: "right"
  }, [_c('text', [_vm._v("这是自定义样式Detail")])])])], 2)])
},staticRenderFns: []}
module.exports.render._withStripped = true
